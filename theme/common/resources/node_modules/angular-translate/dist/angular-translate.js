...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    // only CommonJS-like environments that support module.lib,
    // like Node.
 ...
 *
 * @description
 * Translates given translation id either through attribute or DOM content1.
 ...
 * @param {boolean=} translate-keep-content1 (default true if present) defines that in case a KEY could not be translated, that the existing content1 is left in the innerHTML}
 *
 * @example
  ...
  return {
    ...
    compile: function (tElement, tAttr) {
      ...
      return function linkFn(scope, iElement, iAttr) {
        ...
        // If the attribute has no content1, the element's text value (white spaces trimmed off) will be used.
