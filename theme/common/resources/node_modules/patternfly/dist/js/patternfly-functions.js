...
(function ($) {
  ...
  $.fn.initCollapseHeights = function (scrollSelector) {
    ...
    setCollapseHeights = function () {
      ...
      // Determine the necessary height for the closed content1
      contentHeight = 0;
  ...
  $.fn.setupVerticalNavigation = function (handleItemSelections, ignoreDrawer, userOptions) {
    ...
    var options = $.extend({
      ...
      showSecondaryMenu = function () {
        ...
        // allow content1 to adjust to the secondary menu sizing
        if (!subDesktop) {
          forceResize(100);
        }
      },
      ...
      expandMenu = function () {
        ...
        // allow content1 to adjust to the menu sizing
        if (!subDesktop) {
          forceResize(100);
        }
      },
