...
module.config([ '$routeProvider', function($routeProvider) {
    $routeProvider
       ...
       .when('/', {
            templateUrl : resourceUrl + '/partials/landing.html',
            controller : 'HomeCtrl'
        })
        .when('/mocks/:realm', {
...
*  When used in the textarea element, this will select/highlight the textarea content1 on specified action (i.e. click).
*/
